...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "border-border bg-card text-card-foreground gap-4 overflow-hidden rounded-lg py-4 border has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg group/card flex flex-col hover:border-border/80 transition-colors",
        className
      )}
      {...props}
    />
